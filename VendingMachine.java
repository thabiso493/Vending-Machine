...
public class VendingMachine {
	...
	private HashMap<String,Items> stock;
	...
	public void loadItems(String name,  Double price, Integer amount) {
		if (stock.get(name) != null) {
			Items current = stock.get(name);
			current.setQuantity(current.getQuantity() + amount);
		}
		else {
			Items current = new Items(name, price, amount);
			stock.put(name, current);
		}
	}

	public VendingMachine() {
		stock = new HashMap<String, Items>();
	...
	public static void main(String[] args) {
        ...
        VendingMachine airportVending = new VendingMachine();
    ...
    public void buyItem(Integer sel, double money) {
    	...
    	Items current = this.stock.get(this.menu.get(sel));
    ...
    public void dispenseItem(Items newItem) {
